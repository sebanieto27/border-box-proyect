...
<section class="col-lg-8 pt-lg-4 pb-4 mb-3">
    <div class="pt-2 px-4 pl-lg-0 pr-xl-5">
      ...
      <div class="d-sm-flex flex-wrap justify-content-between align-items-center pb-2">
        <h2 class="h3 py-2 mr-2 text-center text-sm-left">Agregar nuevo producto</h2>
        <div class="py-2">
      ...
      <form>
        <div class="form-group pb-2">
          <label class="font-weight-medium" for="unp-product-name">Nombre del producto</label>
          <input class="form-control" type="text" id="unp-product-name"><small class="form-text text-muted">Descripción del producto</small>
        </div>
        <div class="cz-file-drop-area form-group">
          <div class="cz-file-drop-icon czi-cloud-upload"></div><span class="cz-file-drop-message">Arrastre y suelte aquí para cargar la captura de pantalla del producto</span>
          <input class="cz-file-drop-input" type="file">
          <button class="cz-file-drop-btn btn btn-primary btn-sm mb-2" type="button">O seleccione un archivo</button><small class="form-text text-muted">1000 x 800px ideal</small>
        </div>
        <div class="form-group py-2">
          <label class="font-weight-medium" for="unp-product-description">Descripción del producto</label>
        ...
        <div class="form-group py-2">
          <label class="font-weight-medium" for="unp-product-tags">Tags de los productos</label>
